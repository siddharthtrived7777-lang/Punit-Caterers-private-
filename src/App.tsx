...
export default function App() {
  ...
  // Active view for mobile (Form or Live Preview)
  ...
  return (
    <div className="min-h-screen bg-[#F8FAFC] text-[#0F172A] selection:bg-[#2563EB] selection:text-white pb-8">
      ...
      <main className="max-w-7xl mx-auto px-4 mt-6">
        ...
        <div className="flex md:hidden bg-white p-1 rounded-xl shadow-sm mb-6 border border-stone-200">
          <button 
        ...
        {/* Content Layout Grid (Two-column on Desktop, toggled on Mobile) */}
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
          
          {/* LEFT SIDE: FORM INPUT PANEL */}
          <div className={`lg:col-span-7 bg-white rounded-2xl shadow-md border border-stone-100 overflow-hidden ${
...
• Accompaniments: Masala Papad, Salad, Pickles"
          ...
          {/* RIGHT SIDE: LIVE QUOTATION PREVIEW PANEL */}
          <div className={`lg:col-span-5 ${activeTab === 'preview' ? 'block' : 'hidden md:block'}`}>
            <div className="bg-[#FFFFFF] text-[#0F172A] rounded-2xl shadow-2xl border-[12px] border-[#1E40AF] overflow-hidden sticky top-8 relative flex flex-col justify-between" style={{ fontFamily: '"Inter", "Noto Sans Gujarati", sans-serif', minHeight: '650px' }}>
              
              {/* Inner Blue Border */}
              <div className="p-4 md:p-6 h-full flex flex-col justify-between flex-1 relative" style={{ border: '1.5px solid rgba(37, 99, 235, 0.8)', margin: '4px' }}>
                
                {/* Decorative Corners */}
                {/* Top-Left Branch */}
                <div className="absolute top-0 left-0 w-24 h-24 overflow-hidden pointer-events-none select-none">
                  <svg width="96" height="96" viewBox="0 0 96 96">
                    <path d="M 0,0 L 80,0 C 65,20 20,65 0,80 Z" fill="#1E40AF" />
                    <path d="M 0,82 C 24,64 64,24 82,0" fill="none" stroke="#2563EB" strokeWidth="1.5" />
                    <path d="M 10,10 Q 35,35 60,60" stroke="#2563EB" strokeWidth="1" strokeLinecap="round" fill="none" />
                    <path d="M 22,22 Q 30,12 36,18 Q 28,28 22,22 Z" fill="#2563EB" />
                    <path d="M 38,38 Q 46,28 52,34 Q 44,44 38,38 Z" fill="#2563EB" />
                  </svg>
                </div>

                {/* Bottom-Left Swoop */}
                <div className="absolute bottom-0 left-0 w-20 h-20 overflow-hidden pointer-events-none select-none">
                  <svg width="80" height="80" viewBox="0 0 80 80">
                    <path d="M 0,80 L 0,55 C 15,65 65,75 80,80 Z" fill="#1E40AF" />
                    <path d="M 0,53 C 18,63 67,73 80,78" fill="none" stroke="#2563EB" strokeWidth="1" />
                  </svg>
                </div>

                {/* Bottom-Right Branch */}
                <div className="absolute bottom-0 right-0 w-24 h-24 overflow-hidden pointer-events-none select-none">
                  <svg width="96" height="96" viewBox="0 0 96 96">
                    <path d="M 96,96 L 16,96 C 28,76 76,28 96,16 Z" fill="#1E40AF" />
                    <path d="M 96,13 C 72,31 31,72 13,96" fill="none" stroke="#2563EB" strokeWidth="1.5" />
                    <path d="M 86,86 Q 61,61 36,36" stroke="#2563EB" strokeWidth="1" strokeLinecap="round" fill="none" />
                    <path d="M 74,74 Q 66,84 60,78 Q 68,68 74,74 Z" fill="#2563EB" />
                    <path d="M 58,58 Q 50,68 44,62 Q 52,52 58,58 Z" fill="#2563EB" />
                  </svg>
                </div>

                {/* Top-Right Ribbon Badge */}
                <div className="absolute top-0 right-4 w-16 h-28 pointer-events-none select-none z-10">
                  <svg width="64" height="112" viewBox="0 0 64 112">
                    <path d="M 3,0 L 61,0 L 61,92 L 32,76 L 3,92 Z" fill="#1E40AF" />
                    <path d="M 6,0 L 6,87 L 32,73 L 58,87 L 58,0" fill="none" stroke="#2563EB" strokeWidth="1.2" />
                    <path d="M 8,0 L 8,85 L 32,71 L 56,85 L 56,0" fill="none" stroke="#2563EB" strokeWidth="0.4" opacity="0.8" />
                    ...
                    <g transform="translate(20, 10) scale(0.8)">
                      ...
                      <path d="M 6,18 L 22,18" stroke="#2563EB" strokeWidth="1.5" />
                    </g>
                    <text x="32" y="44" fill="#fff" fontSize="6.5" fontWeight="bold" fontFamily="Georgia, serif" textAnchor="middle" letterSpacing="0.05em">CATERING</text>
                    <text x="32" y="53" fill="#fff" fontSize="6.5" fontWeight="bold" fontFamily="Georgia, serif" textAnchor="middle" letterSpacing="0.05em">QUOTATION</text>
                    <path d="M 20,62 Q 32,56 44,62" fill="none" stroke="#2563EB" strokeWidth="0.8" />
                    <circle cx="32" cy="59" r="1" fill="#2563EB" />
                  </svg>
                </div>

                {/* Branding Block / Logo Header */}
                <div className="text-center pt-3 pb-4">
                  <span className="tracking-[0.25em] text-[9px] font-bold block text-blue-500 font-serif mb-1">✨ SHREE GANESHAY NAMAH ✨</span>
                  
                  <h1 className="font-serif font-extrabold tracking-widest text-xl text-[#1E40AF]">PUNIT CATERERS</h1>
                  <p className="text-[9px] tracking-[0.2em] font-bold uppercase text-[#2563EB] mt-0.5">Delicious Food • Memorable Events</p>
                  
                  {/* Title Divider Flourish */}
                  <div className="flex items-center justify-center my-2 select-none pointer-events-none">
                    <svg width="110" height="8" viewBox="0 0 110 8">
                      <path d="M 0,4 L 42,4 Q 46,1 50,4 Q 54,7 58,4 Q 62,1 66,4 L 110,4" fill="none" stroke="#2563EB" strokeWidth="1" />
                      <circle cx="54" cy="4" r="2" fill="#1E40AF" stroke="#2563EB" strokeWidth="0.5" />
                    </svg>
                  </div>
                </div>

                {/* Structured Info Grid - Dual Column with Circle Icons */}
                <div className="bg-white/80 border border-stone-200/60 rounded-2xl p-4 shadow-sm space-y-3.5 mb-5 relative z-10">
                  
                  {/* Client Name & Serving Time */}
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                    <div className="flex items-center gap-2.5">
                      <div className="w-8.5 h-8.5 rounded-full bg-[#EFF4FF] border border-blue-200 flex items-center justify-center shrink-0">
                        <User className="w-4.5 h-4.5 text-[#2563EB]" />
                      </div>
                      <div className="min-w-0">
                        <p className="text-[8.5px] uppercase tracking-wider font-bold text-stone-500">Client Name / ગ્રાહકનું નામ</p>
                        <p className="font-extrabold text-xs text-stone-900 truncate">{clientName.trim() || 'N/A'}</p>
                      </div>
                    </div>

                    <div className="flex items-center gap-2.5 border-stone-100 sm:border-l sm:pl-3">
                      <div className="w-8.5 h-8.5 rounded-full bg-[#EFF4FF] border border-blue-200 flex items-center justify-center shrink-0">
                        <Clock className="w-4.5 h-4.5 text-[#2563EB]" />
                      </div>
                      <div className="min-w-0">
                        <p className="text-[8.5px] uppercase tracking-wider font-bold text-stone-500">Time / સમય</p>
                        <p className="font-extrabold text-xs text-stone-900 truncate">{servingTime.trim() || 'N/A'}</p>
                      </div>
                    </div>
                  </div>

                  {/* Event Address & Total Guests */}
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 border-t border-stone-100 pt-3">
                    <div className="flex items-center gap-2.5">
                      <div className="w-8.5 h-8.5 rounded-full bg-[#EFF4FF] border border-blue-200 flex items-center justify-center shrink-0">
                        <MapPin className="w-4.5 h-4.5 text-[#2563EB]" />
                      </div>
                      <div className="min-w-0">
                        <p className="text-[8.5px] uppercase tracking-wider font-bold text-stone-500">Event Address / પ્રસંગનું સ્થળ</p>
                        <p className="font-extrabold text-[11px] text-stone-900 line-clamp-1 break-all">{eventAddress.trim() || 'N/A'}</p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-center gap-2.5 border-stone-100 sm:border-l sm:pl-3">
                      ...
                      <div className="min-w-0">
                        <p className="text-[8.5px] uppercase tracking-wider font-bold text-stone-500">Total Plates / કુલ પ્લેટ</p>
                        <p className="font-extrabold text-xs text-[#2563EB]">{totalGuests || 'N/A'} Plates</p>
                      </div>
                    </div>
                  </div>

                  {/* Event Date & Food Type */}
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 border-t border-stone-100 pt-3">
                    <div className="flex items-center gap-2.5">
                      <div className="w-8.5 h-8.5 rounded-full bg-[#EFF4FF] border border-blue-200 flex items-center justify-center shrink-0">
                      ...
                      <div className="min-w-0">
                        <p className="text-[8.5px] uppercase tracking-wider font-bold text-stone-500">Event Date / પ્રસંગની તારીખ</p>
                        <p className="font-extrabold text-xs text-[#2563EB]">{eventDate || 'N/A'}</p>
                      </div>
                    </div>

                    <div className="flex items-center gap-2.5 border-stone-100 sm:border-l sm:pl-3">
                      <div className="w-8.5 h-8.5 rounded-full bg-[#EFF4FF] border border-blue-200 flex items-center justify-center shrink-0">
                        <Utensils className="w-4.5 h-4.5 text-[#2563EB]" />
                      </div>
                      <div className="min-w-0">
                        <p className="text-[8.5px] uppercase tracking-wider font-bold text-stone-500">Food Type / ભોજનનો પ્રકાર</p>
                        <p className="font-extrabold text-xs text-stone-900 leading-normal">
                          {FOOD_TYPE_LABELS[foodType].en} / {FOOD_TYPE_LABELS[foodType].gu.split(' ')[1]}
                          {foodType === 'Jain' && jainPlates !== '' && (
                            <span className="block text-[10px] text-[#2563EB] font-bold mt-0.5">
                ...
                {/* Selected Menu Block - Responsive columns inside blue container */}
                <div className="bg-[#EFF4FF] border border-[#2563EB]/25 rounded-2xl p-4 pt-5 pb-3.5 relative mb-4 shadow-inner">
                  {/* Crimson Title Tab */}
                  <div className="absolute -top-3 left-4 bg-[#1E40AF] text-white px-3 py-0.5 rounded-md text-[9px] font-bold tracking-wider uppercase flex items-center gap-1 shadow-sm border border-[#2563EB]/35">
                    <Utensils className="w-3 h-3 text-blue-100" />
                    <span>Selected Menu / મેનુ</span>
                  </div>

                  {(!selectedMenu.trim()) ? (
                    <p className="text-stone-400 italic text-[11px] text-center py-5">No items selected yet. Please type in the menu field.</p>
                  ) : (
                    <div className="grid grid-cols-1 sm:grid-cols-3 gap-x-4 gap-y-2 max-h-48 overflow-y-auto">
                      {getMenuColumns(selectedMenu).map((col, colIdx) => (
                        <div key={colIdx} className="space-y-1">
                          {col.map((item, itemIdx) => (
                            <div key={itemIdx} className="flex items-start gap-1 text-[10.5px] text-stone-850 font-semibold leading-tight">
                ...
                {/* 3-Column Pricing Boxes */}
                <div className="grid grid-cols-3 gap-2 mt-2">
                  <div className="bg-stone-50 border border-stone-200/60 rounded-xl p-2 flex flex-col items-center justify-center text-center">
                    <div className="w-7 h-7 rounded-full bg-stone-100 flex items-center justify-center mb-0.5">
                      <IndianRupee className="w-3.5 h-3.5 text-stone-700" />
                    </div>
                    <span className="text-[7.5px] uppercase tracking-wider font-bold text-stone-500">Per Plate</span>
                    <span className="font-extrabold text-stone-900 text-xs mt-0.5">₹{perPlateRate || '0'}</span>
                  </div>

                  <div className="bg-[#EFF4FF] border border-[#2563EB]/20 rounded-xl p-2 flex flex-col items-center justify-center text-center">
                    <div className="w-7 h-7 rounded-full bg-blue-100/50 flex items-center justify-center mb-0.5">
                      <Users className="w-3.5 h-3.5 text-[#2563EB]" />
                    </div>
                    <span className="text-[7.5px] uppercase tracking-wider font-bold text-[#1E40AF]">Total Plates</span>
                    <span className="font-extrabold text-[#1E40AF] text-xs mt-0.5">{totalGuests || '0'}</span>
                  </div>

                  <div className="bg-[#EFF4FF] border border-blue-200 rounded-xl p-2 flex flex-col items-center justify-center text-center">
                    <div className="w-7 h-7 rounded-full bg-blue-100 flex items-center justify-center mb-0.5">
                      <IndianRupee className="w-3.5 h-3.5 text-[#1E40AF] stroke-[2.5]" />
                    </div>
                    <span className="text-[7.5px] uppercase tracking-wider font-bold text-[#1E40AF]">Total Amount</span>
                    <span className="font-extrabold text-[#1E40AF] text-xs mt-0.5">₹{totalAmount || '0'}</span>
                  </div>
                </div>

                {/* Special Instructions */}
                <div className="bg-stone-50/50 border border-stone-200/50 rounded-xl p-2.5 flex items-start gap-2.5 mt-3">
                  <div className="w-7 h-7 rounded-full bg-[#EFF4FF] border border-[#2563EB]/20 flex items-center justify-center shrink-0">
                    <FileText className="w-4 h-4 text-[#2563EB]" />
                  </div>
                  <div className="min-w-0">
                    <p className="text-[8px] uppercase tracking-wider font-bold text-stone-400">Special Instructions / સૂચનાઓ</p>
                    <p className="text-[10px] text-stone-600 italic font-medium leading-relaxed truncate">
                      {specialInstructions.trim() || 'None / કોઈ સૂચના નથી'}
                    </p>
                  </div>
                </div>

                {/* Footer Brand Flourish & Signatures */}
                <div className="text-center pt-4 mt-4 border-t border-dashed border-stone-200">
                  <span className="italic font-serif text-stone-500 text-[10px] block mb-0.5">Thank you for choosing</span>
                  <div className="flex items-center justify-center gap-2">
                    <svg width="24" height="12" viewBox="0 0 32 16" className="inline-block shrink-0 rotate-180">
                      <path d="M 0,8 Q 16,3 32,8" fill="none" stroke="#2563EB" strokeWidth="1" />
                      <path d="M 8,5 Q 12,1 16,6 Q 12,10 8,5 Z" fill="#2563EB" />
                    </svg>
                    <span className="font-serif font-extrabold tracking-widest text-[12px] text-[#1E40AF]">PUNIT CATERERS</span>
                    <svg width="24" height="12" viewBox="0 0 32 16" className="inline-block shrink-0">
                      <path d="M 0,8 Q 16,3 32,8" fill="none" stroke="#2563EB" strokeWidth="1" />
                      <path d="M 8,5 Q 12,1 16,6 Q 12,10 8,5 Z" fill="#2563EB" />
                    </svg>
                  </div>
                  <p className="text-[7.5px] text-stone-400 font-medium tracking-wide mt-1">Serving Love since 1995 • Generated on {new Date().toLocaleDateString('en-IN')}</p>
                </div>
